...
!----------------------------------------------------------------------------------------------------------
    ...
    if(dm%ibcy_qy(1) == IBC_PERIODIC ) then
      ncly1 = 0
    else if (dm%ibcy_qy(1) == IBC_DIRICHLET ) then
      ncly1 = 2
    else
      ncly1 = 1
    end if
    ...
    if(dm%ibcz_qz(1)  == IBC_PERIODIC ) then
      nclz1 = 0
    else if (dm%ibcz_qz(1)  == IBC_DIRICHLET ) then
      nclz1 = 2
    else
      nclz1 = 1
    end if
...
!#endif
      ...
      if(skip_c2c(2)) then
        poisson => poisson_010_yskip
        if(nrank == 0) write(*,*) 'poisson_010_yskip is used.'
      else
        poisson => poisson_010
       ...
       if(skip_c2c(2)) then
        poisson => poisson_11x_yskip
        if(nrank == 0) write(*,*) 'poisson_11x_yskip is used.'
      else
        poisson => poisson_11x
...
!-----------------------------------------------------------
    ...
    return
  end subroutine poisson_010_yskip
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
