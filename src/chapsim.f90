...
!> equations, and finalizes the run.
!>
!> This file is part of CHAPSim, a general-purpose CFD tool licensed under the
...
!> substep updates, CFL and mass-conservation checks, momentum/energy/MHD
!> equation updates, monitor output, and graceful termination at the configured
!> final iteration.
...
!> Finalize CHAPSim after the solver loop.
!>
!> Records final timing information and finalizes MPI.
